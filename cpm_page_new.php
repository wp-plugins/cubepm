...
function cpm_page_new_form(){
	...
	$html .= '<p><label for="cpm_recipient">'.__('To', 'cubepm').':</label><br /><input type="text" name="cpm_recipient" id="cpm_recipient" value="'.$cpm_recipient.'" /></p>';
	...
	$html .= '<p><input type="submit" name="cpm_submit" id="cpm_submit" value="'.__('Send PM', 'cubepm').' &raquo;" /></p>';
	$html .= '</form>';
	return $html;
}
